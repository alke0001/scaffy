/**
 * Flat EN/DE copy. English is `as const` so `MessageKey` catches typos at compile time
 * (`t()` / `$messages['…']`) instead of loose string keys. EN/DE parity is enforced by
 * `pnpm run check:i18n` — see ADR-020.
 */
...
const EN_MESSAGES = {
	...
	'editor.lessonReadyHint1': 'Read the concept preview in the Scaffy tutor panel on the right. 👉',
...
const DE_MESSAGES = {
	...
	'editor.loadingVerb2': 'Architektur wird mit der Gummiente besprochen...',
	'editor.loadingVerb3': 'Tutorials werden in echte Fähigkeiten verwandelt...',
	'editor.loadingVerb4': 'Zwiebeln werden karamellisiert...',
	...
	'editor.lessonReadyHint2': 'Klicke dort auf „Verstanden — Lektion starten“, wenn du bereit bist.',
...
export const TRANSLATIONS: Record<LanguageCode, Record<MessageKey, string>> = {
	en: EN_MESSAGES,
	de: DE_MESSAGES as Record<MessageKey, string>,
};
