...
<ScrollArea bind:viewportRef={listEl} orientation="vertical" class="min-h-0 flex-1 px-1 py-2">
	<div class="flex flex-col gap-3" role="log" aria-live="polite" aria-relevant="additions text">
